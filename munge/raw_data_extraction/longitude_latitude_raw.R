##############################################################################-
## Project: Alcohol
## Script purpose: scrape longitude and latitude of all countries
## Date: 2019-10-13
...
## Overview ----
##############################################################################-
# Could not get rvest to cooperate so I just used datapasta to paste the table as a tribble.
# data are from https://developers.google.com/public-data/docs/canonical/countries_csv
...
write_csv(longitude_latitude, file_longitude_latitude_raw)