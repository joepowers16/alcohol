...
DATA_TARGETS = consumption_latlong_ppp.rds

# Reports
REPORT_TARGETS = drinks_eda.md
...
consumption_latlong_ppp.rds: consumption_latlong_ppp.R consumption.csv \
longitude_latitude_raw.csv API_NY.GDP.PCAP.PP.CD_DS2_en_csv_v2_247784.csv
	Rscript $<
...
drinks_eda.md: drinks_eda.Rmd consumption_latlong_ppp.rds
	$(RENDER)
